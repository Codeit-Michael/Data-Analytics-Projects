# solution link: https://replit.com/@Codeit-Michael/boilerplate-demographic-data-analyzer-1#demographic_data_analyzer.py
import pandas as pd
...
def calculate_demographic_data(print_data=True):
  ...
  percentage_bachelors = round(df["education"].str.contains("Bachelors").sum() / len(df) * 100, 1)
  ...
  rich_country_percentage = rich_per_country / people_per_country * 100
